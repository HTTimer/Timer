	...
	scramblers.lib = {
		...
		randomInt: function() {
			function n() {
				...
				console.warn ? console.warn(n) : console.log(n), e = true;
			}
			...
			if (i) {
				...
				console.error ? console.error(l) : console.log(l),
					a = function() {
						if (e)
...
(function() {
	//size defines the size of cube, seqlen the number of moves, mult does some thing with multislice reduction
	var generate_NNN_scrambler = function(size, seqlen, mult) {
		return (function() {
			...
			// One letter, JPG Image (?), color name
			// To change colors, also take a look @ colorGet
